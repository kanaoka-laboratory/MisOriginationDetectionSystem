...
foreach($asn_list as $asn => $null){
	echo "insert into ConflictAsnWhiteList (conflict_type,asn,conflict_asn,date_register) values($conflict_type_manars,$asn,0,'$today');".PHP_EOL;
}
echo "commit;".PHP_EOL;
?>
